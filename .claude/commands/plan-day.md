...
8. **AUTOMATIC CALENDAR INTEGRATION**: After plan validation, automatically create calendar events:
   ...
   8a. **RITUAL BOOKING FIRST**: Create calendar events for all detected rituals:
   ```
   For each ritual identified in step 3.5 ritual constraints:
   
   mcp__google-calendar__create-event:
   - calendarId: "primary"
   - summary: [Ritual name with appropriate emoji]
   - start: [ISO datetime in Australia/Sydney] 
   - end: [ISO datetime in Australia/Sydney]
   - timeZone: "Australia/Sydney"
   - description: [Include ALL of the following]:
     • Ritual purpose and activity description
     • Ritual type (foundational/work/life/maintenance)
     • Duration and frequency information
     • UUID tracking section:
       🔗 RITUAL_UUID: [UUID from ritual-cli-v2 output]
       📊 RITUAL_TYPE: [foundational/work/life/maintenance]
       ⚡ FREQUENCY: [daily/weekly/monthly/etc]
       🎯 PRIORITY: [high/medium/low]
     • "Generated by Ritual Management System V2"
   ...
   **Description Template**:
   ...
   8d. **Execution Summary**: Report calendar integration results:
   ```
